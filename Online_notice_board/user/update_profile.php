...
$query="update user set name='$n',mobile='$mob',gender='$gen',hobbies='$hob',dob='$dob' where email='".$_SESSION['user']."',college='$college'";
...
<h2 align="center"><B>UPDATE YOUR PROFILE</B></h2>
	...
	<Tr>
		<Td colspan="2"><?php echo @$err;?></Td>
				...
				<tr>
					<td>Enter Your College</td>
					<Td><input class="form-control" value="<?php echo $res['college	'];?>"  type="text" name="college"/></td>
				</tr>
				<tr>
