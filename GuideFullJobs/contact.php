...
<head>
	...
	<title>GuideFull Jobs - Contact Us</title>
					...
					<div class="row">
						...
						<div class="col-sm-5 col-md-4">
							...
							<ul class="address-list">
								<li>
										<h5>Address</h5>
										<address> Vadodara, <br/> Gujarat</address>
								</li>
								<li>
										<h5>Email</h5><a href="mailto:GuideFull@gmail.com">GuideFull@gmail.com</a>
								</li>
								<li>
										<h5>Phone Number</h5><a href="tel:+91 6356144561">+91 6356144561</a>
								</li>
