...
require '../constants/uniques.php';
	...
	$message = "Hellow!! <b>$full_name</b>, <br>Click <a href='$actual_link'>HERE</a> to reset your <b>GuideFullJobs</b> password.";   
    ...
    $mail->isSMTP();                                      
    $mail->Host = 'GuideFull@gmail.com';
    $mail->SMTPAuth = true;                           
    $mail->Username = 'sahilgandhi0810@gmail.com';               
    $mail->Password = 'epswbyrhhlaaemrk';                          
    $mail->SMTPSecure = 'tls';                            
    $mail->Port = 587;                                   

    $mail->setFrom($smtp_user, 'GuideFull-JObs@no-reply');
