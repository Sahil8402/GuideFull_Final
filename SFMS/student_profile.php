...
<html lang = "en">
	<head>
		<title>GuideFull | Students</title>
		<meta charset = "utf-8" />
...
<body style="background: url('../images/b2.jpg');">
		<div class="container-fluid">
		<h1 align="center" style="color: #fff;"><img src="../images/GuideFulllogo.jpg" style="border-radius: 10px;" height="50px">uideFull File Management System</h1>
		</div>
	<div class="col-md-4">
		<?php
